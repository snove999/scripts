...
```text
https://raw.githubusercontent.com/snove999/scripts/main/huangdou/huangdou.plugin
```

### 专题播放转圈/暂停

若 m3u8 能返回但视频持续转圈暂停，通常是运营商反诈 DNS/HTTP 拦截了 CloudFront 媒体分片。把以下分流订阅添加到分流规则，并确保 `proxy` 策略可用：

```text
https://raw.githubusercontent.com/snove999/scripts/main/huangdou/media-proxy.list
```
